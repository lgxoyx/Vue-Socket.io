...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VueSocketIO; });
/* harmony import */ var _mixin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _listener__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _emitter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
...
let VueSocketIO = /*#__PURE__*/function () {
  /**
   ...
   * @param options
   */
  function VueSocketIO({
    connection,
    vuex,
    debug,
    options
  }) {
    _classCallCheck(this, VueSocketIO);
    _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug = debug;
    this.io = this.connect(connection, options);
    this.emitter = new _emitter__WEBPACK_IMPORTED_MODULE_3__["default"](vuex);
    this.listener = new _listener__WEBPACK_IMPORTED_MODULE_2__["default"](this.io, this.emitter);
  }
   ...
   * @param Vue
   */
  _createClass(VueSocketIO, [{
    key: "install",
    value: function install(Vue) {
      Vue.config.globalProperties.$socket = this.io;
      Vue.config.globalProperties.$vueSocketIo = this;
      Vue.provide('socket', this.io);
      Vue.mixin(_mixin__WEBPACK_IMPORTED_MODULE_0__["default"]);
      _logger__WEBPACK_IMPORTED_MODULE_1__["default"].info('Vue-Socket.io plugin enabled');
    }
    ...
    key: "connect",
    value: function connect(connection, options) {
      if (connection && typeof connection === 'object') {
        console.log('error', connection, options);
        _logger__WEBPACK_IMPORTED_MODULE_1__["default"].info('Received socket.io-client instance');
        return connection;
      } else if (typeof connection === 'string') {
        _logger__WEBPACK_IMPORTED_MODULE_1__["default"].info('Received connection string');
        return this.io = socket_io_client__WEBPACK_IMPORTED_MODULE_4___default()(connection, options);
      } else {
        console.log('error', connection, options);
...
/* harmony default export */ __webpack_exports__["default"] = (new ( /*#__PURE__*/function () {
  function VueSocketIOLogger() {
    _classCallCheck(this, VueSocketIOLogger);
    this.debug = false;
    this.prefix = '%cVue-Socket.io: ';
  }
  _createClass(VueSocketIOLogger, [{
    key: "info",
    value: function info(text, data = '') {
    ...
    key: "event",
    value: function event(text, data = '') {
      if (this.debug) window.console.info(this.prefix + `%c${text}`, 'color: blue; font-weight: 600', 'color: #333333', data);
    }
  }]);
  return VueSocketIOLogger;
}())());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VueSocketIOListener; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
let VueSocketIOListener = /*#__PURE__*/function () {
  function VueSocketIOListener(io, emitter) {
    _classCallCheck(this, VueSocketIOListener);
    this.io = io;
    this.register();
   ...
   */
  _createClass(VueSocketIOListener, [{
    key: "register",
    ...
    key: "onEvent",
    value: function onEvent(event, args) {
      this.emitter.emit(event, args);
    }
  }]);
  return VueSocketIOListener;
}();
/**
 * socket.io-client reserved event keywords
 * @type {string[]}
 */
_defineProperty(VueSocketIOListener, "staticEvents", ['connect', 'error', 'disconnect', 'reconnect', 'reconnect_attempt', 'reconnecting', 'reconnect_error', 'reconnect_failed', 'connect_error', 'connect_timeout', 'connecting', 'ping', 'pong']);
...
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
...
let EventEmitter = /*#__PURE__*/function () {
  function EventEmitter(vuex = {}) {
    _classCallCheck(this, EventEmitter);
    _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(vuex ? `Vuex adapter enabled` : `Vuex adapter disabled`);
    _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(vuex.mutationPrefix ? `Vuex socket mutations enabled` : `Vuex socket mutations disabled`);
    _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(vuex ? `Vuex socket actions enabled` : `Vuex socket actions disabled`);
  ...
  _createClass(EventEmitter, [{
    ...
    value: function addListener(event, callback, component) {
      if (typeof callback === 'function') {
        ...
        _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(`#${event} subscribe, component: ${component.$options.name}`);
      } else {
    ...
    value: function removeListener(event, component) {
      if (this.listeners.has(event)) {
        ...
        _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(`#${event} unsubscribe, component: ${component.$options.name}`);
      }
    }
    ...
    value: function emit(event, args) {
      if (this.listeners.has(event)) {
        _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(`Broadcasting: #${event}, Data:`, args);
      ...
      if (this.store && this.store._actions) {
        ...
        for (let key in this.store._actions) {
          ...
          if (action === prefixed_event) {
            _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(`Dispatching Action: ${key}, Data:`, args);
        ...
        if (this.mutationPrefix) {
          ...
          for (let key in this.store._mutations) {
            ...
            if (mutation === prefixed_event) {
              _logger__WEBPACK_IMPORTED_MODULE_0__["default"].info(`Commiting Mutation: ${key}, Data:`, args);
